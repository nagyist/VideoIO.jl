...
function sws_getContext(_srcW::Integer,_srcH::Integer,srcFormat::AVPixelFormat,_dstW::Integer,_dstH::Integer,dstFormat::AVPixelFormat,_flags::Integer,_srcFilter::Ptr,_dstFilter::Ptr,_param::Ptr)
    srcW = int32(_srcW)
    srcH = int32(_srcH)
    dstW = int32(_dstW)
    dstH = int32(_dstH)
...
function sws_getCachedContext(_context::Ptr,_srcW::Integer,_srcH::Integer,srcFormat::AVPixelFormat,_dstW::Integer,_dstH::Integer,dstFormat::AVPixelFormat,_flags::Integer,_srcFilter::Ptr,_dstFilter::Ptr,_param::Ptr)
