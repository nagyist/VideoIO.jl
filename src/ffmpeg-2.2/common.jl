...
function av_log2(_v::Integer)
    v = uint32(_v)
    ccall((:av_log2,libavutil),Cint,(Uint32,),v)
end
function av_log2_16bit(_v::Integer)
    v = uint32(_v)
    ccall((:av_log2_16bit,libavutil),Cint,(Uint32,),v)
end
...
function av_sat_add32_c(_a::Integer,_b::Integer)
    a = int32(_a)
    b = int32(_b)
    ccall((:av_sat_add32_c,libavutil),Cint,(Cint,Cint),a,b)
end
function av_sat_dadd32_c(_a::Integer,_b::Integer)
    a = int32(_a)
    b = int32(_b)
