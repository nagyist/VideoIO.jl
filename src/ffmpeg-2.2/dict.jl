...
function av_dict_parse_string(_pm::Ptr,_str::Union(Ptr,ByteString),_key_val_sep::Union(Ptr,ByteString),_pairs_sep::Union(Ptr,ByteString),_flags::Integer)
    pm = convert(Ptr{Ptr{AVDictionary}},_pm)
